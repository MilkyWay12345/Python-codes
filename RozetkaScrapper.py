...
class ScrapperLogic:
    ...
    def inner_html(element):
        return element.decode_countents(formatter = "html")
    ...
    def get_phone_number(self, body):
        ...
        phone_no = "No Number!"
        try:
            for item in body.find('p', {'class': 'content-info'}):
                i += 1
                if i == 2:
                    phone_no = ''
                    try:
    ...
    def start_scrapping_logic(self):
        ...
        total_url = "https://www.rozetka.com.ua/{0}/{1}".format(self.location, self.query)
        ...
        while True:
            ...
            req = urllib.request.Request(url, headers = {'User-Agent': "Google Chrome/86.0 (Windows NT 6.1; Win64; x64)"})
