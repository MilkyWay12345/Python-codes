...
def rules():
    ...
    print("The positions of this 3 x 3 board is same as right side of your key board.\n")
    print(" 7 | 8 | 9 ")
    print("-----------")
    print(" 4 | 5 | 6 ")
    print("-----------")
    print(" 1 | 2 | 3 ")
    print("\nYou just have to input the positions (1-9).")
...
def place_market(board, avail, choice, position):
...
while True:
    ...
    while play_game:
        if turn == p1_name:
            ...
            place_market(theBoard, available, p1_choice, position)
            ...
            place_market(theBoard, available, p2_choice, position)
