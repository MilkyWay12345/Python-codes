...
def convertToPNG():
    ...
    if im1 is None:
        ...
        export_file_path = filedialog.asksaveasfilename(defaultextention = '.png')
        im1.save(export_file_path)

saveAsButton_PNG = tk.Button(text = 'Converter JPEG to PNG', command = convertToPNG, bg = bg, fg = fg, font = font)
